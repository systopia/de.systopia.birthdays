...
// Make CRM_Birthdays_ExtensionUtil available.
require_once __DIR__ . '/../../birthdays.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.birthdays');
 ...
 */
function _birthdays_test_civicrm_container(ContainerBuilder $container): void {
}
