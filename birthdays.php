 ...
 */
function birthdays_civicrm_disable() {
  _birthdays_civix_civicrm_disable();
}
 ...
 */
function birthdays_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _birthdays_civix_civicrm_upgrade($op, $queue);
}
