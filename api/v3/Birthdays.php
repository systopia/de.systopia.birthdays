 ...
 */
function _civicrm_api3_birthdays_sendgreetings_spec(&$params): void {
  $params['debug_email'] = [
    'name'         => 'debug_email',
    'api.required' => 0,
 ...
 *
 * @param array<string, mixed> $params API call parameters
 *
 * @return array<string, mixed> API3 response
 */
